...
1. If the pottery is **not** cracked, price the pottery and add the object to the module-level array of items to be sold.
1. If the weight of the uncracked piece of pottery is greater than, or equal to, 6 then the function must add a `price` property with a value of 40.
1. If the weight of the uncracked piece of pottery is less than 6 then the function must add a `price` property with a value of 20.
1. `toSellOrNotToSell` should return the augmented object.
